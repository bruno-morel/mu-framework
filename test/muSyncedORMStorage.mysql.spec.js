...
describe( "muSync with MySQL Storage linked", function()
{
	...
	var muSyncMock = new mu.Sync.EndPoint( apiURL, 8005, true, muORMMock );
	...
	it( "are defined and linked", function()
	{
        ...
        expect( muSyncMock.objectList ).toEqual( muMySQLDrvStorageMock.objectList );
        expect( muSyncMock.objectInstances ).toEqual( muMySQLDrvStorageMock.objectInstances );
