...
muBrowser.prototype.post    = function ( urlToPostTo, dataToPost, callWhenPosted )
{
	var urlObject = '';
	...
	postRequest.write( dataToPost );

	postRequest.end();
};


muBrowser.prototype.push    = function ( urlToPushTo, dataToPush, callWhenPushed )
{
    var urlObject = '';
