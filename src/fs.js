...
( function( exports )
{
    ...
    {
        var schemaList = ajaxXMLHTTPRequest( finalurl + 'index.json', 'no schema file list present...we ll be db-less. going on' );

	    try{ schemaList = JSON.parse( schemaList ); }
	    catch( parseError ){ mu.error( 'impossible to parse directory index' ); }
