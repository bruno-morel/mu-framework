...
describe( "muSync with MySQL Storage linked", function()
{
	...
	var muSyncMock = new mu.Sync.EndPoint( 8005, true, muORMMock );
			...
			runs( function()
			      {
				      expect( responseValue.statusCode ).toEqual( 200 );
				      expect( responseValue.contentType ).toEqual( 'text/html' );
				      expect( responseValue.grabbedDatas ).toEqual( '<!DOCTYPE html><html><head><title>muORMTestMix properties</title></head><body><div><ul>muORMTestMixString<li>name value is a string with this as default</li></ul><ul>muORMTestMixDate<li>Mon Mar 12 2012 00:00:00 GMT+0100 (CET)</li></ul><ul>muORMTestMixNumeric<li>15</li></ul></div></body></html>' );
			...
			runs( function()
			      {
				      ...
				      expect( responseValue.grabbedDatas ).toEqual( '{"muORMTestMixString":"name value is a string with this as default","muORMTestMixDate":"2012-03-11T23:00:00.000Z","muORMTestMixNumeric":15}' );
