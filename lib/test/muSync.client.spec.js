		...
		runs( function()
		      {
			      ...
			      mockTestNumeric1.muORMTestNumeric1 = 11;
			      mockTestNumeric1.muORMTestNumeric2 = 12;
			      mockTestNumeric1.muORMTestNumeric3 = 13;

			      expect( mockTestNumeric1.muORMTestNumeric1 ).toEqual( 11 );
			      expect( mockTestNumeric1.muORMTestNumeric2 ).toEqual( 12 );
			      expect( mockTestNumeric1.muORMTestNumeric3 ).toEqual( 13 );
