...
describe( "muStorage", function()
{
    ...
    it( "is defined and has default properties and set to default storage values", function()
    {
        ...
        expect( muDefaultStorageMock.driverName ).toEqual( 'memory' );
        expect( muDefaultStorageMock.engineName ).toEqual( '' );
        ...
        expect( muDefaultStorageMock.lastMuUID ).toBeDefined( );
        expect( muDefaultStorageMock.newMuUID ).toBeDefined( );
        expect( muDefaultStorageMock.delMuUID ).toBeDefined( );
        expect( muDefaultStorageMock.getItem ).toBeDefined( );
        expect( muDefaultStorageMock.setItem ).toBeDefined( );
        expect( muDefaultStorageMock.storageURI ).toEqual( 'memory://~/' );
    });
    ...
    it( "owns an object inside its constructor and create the necessary UUID (anonymous function AND classic function as constructor)", function()
    {
        ...
        var mockPrototypeAnonymous = function ( constructParameterTest )
            {
                ...
                muDefaultStorageMock.ownObject( this, 'mockPrototypeAnonymous' );
            };
        ...
        {
            this.mockProperty = constructParameterTest;
            muDefaultStorageMock.ownObject( this );
        }
    ...
    it( "owns an object outside its constructor and create all the necessary UUID (anonymous function AND classic function as constructor)", function()
    {
        ...
        muDefaultStorageMock.ownObject( mockObjectFromAnonymous );
        ...
        muDefaultStorageMock.ownObject( mockObjectFromAnonymous2 );
        ...
        muDefaultStorageMock.ownObject( mockObject );
        ...
        muDefaultStorageMock.ownObject( mockObject2 );
    ...
    it( "has a working persistent default storage (owning the object from the constructor)", function()
    {
        ...
        {
            this.mockProperty = constructParameterTest;
            muPersistentStorageMock.ownObject( this, 'mockPrototypePersistent' );
        }
    ...
    it( "has a working session default storage (owning the object from the constructor)", function()
    {
        ...
        {
            this.mockProperty = constructParameterTest;
            muSessionStorageMock.ownObject( this, 'mockPrototypeSession' );
        }
