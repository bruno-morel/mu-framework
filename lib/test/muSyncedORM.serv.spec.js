		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muORMWithSyncTestNumeric',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode      = statusCode;
					      responseValue.contentType     = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muORMWithSyncTestNumeric.json',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode      = statusCode;
					      responseValue.contentType     = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muORMWithSyncTestNumeric/' + currentMuUID,
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode      = statusCode;
					      responseValue.contentType     = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muORMWithSyncTestNumeric/' + currentMuUID + '.json',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode      = statusCode;
					      responseValue.contentType     = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muORMWithSyncTestNumeric.bla',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode      = statusCode;
					      responseValue.contentType     = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muORMWithSyncTestNumeric.bla?json',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode      = statusCode;
					      responseValue.contentType     = contentType;
