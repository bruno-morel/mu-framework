			...
			runs( function()
			      {
				      expect( responseValue.statusCode ).toEqual( 200 );
				      expect( responseValue.contentType ).toEqual( 'text/html' );
				      expect( responseValue.grabbedDatas ).toEqual( '<!DOCTYPE html><html><head><title>muORMTestNumeric muUID=1 properties</title></head><body><h1>muUID<li>1</li></h1><div><ul>muORMTestNumeric1<li>1</li></ul><ul>muORMTestNumeric2<li>2</li></ul><ul>muORMTestNumeric3<li>3</li></ul></div></body></html>' );
			      } );
		});
			...
			runs( function()
			      {
				      expect( responseValue.statusCode ).toEqual( 200 );
				      expect( responseValue.contentType ).toEqual( 'application/json' );
				      expect( responseValue.grabbedDatas ).toEqual( '{"muUID":1,"muORMTestNumeric1":1,"muORMTestNumeric2":2,"muORMTestNumeric3":3}' );
			      } );
		});
            ...
            runs( function()
                  {
                      expect( responseValue.statusCode ).toEqual( 200 );
                      expect( responseValue.contentType ).toEqual( 'text/html' );
                      expect( responseValue.grabbedDatas ).toEqual( '<!DOCTYPE html><html><head><title>muORMTestNumeric muUID=1 properties</title></head><body><h1>muUID<li>1</li></h1><div><ul>muORMTestNumeric1<li>15</li></ul><ul>muORMTestNumeric2<li>0</li></ul><ul>muORMTestNumeric3<li>15</li></ul></div></body></html>' );
            ...
            runs( function()
                  {
                      ...
                      expect( responseValue.grabbedDatas ).toEqual( '{"muUID":1,"muORMTestNumeric1":15,"muORMTestNumeric2":0,"muORMTestNumeric3":15}' );
