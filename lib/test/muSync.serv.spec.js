...
describe( "muSync", function()
{
	...
	{
		var muSyncMock2 = new mu.Sync.EndPoint( 'localhost', 8001, true, 'test', 2 );
	...
	{
		var muSyncMock3 = new mu.Sync.EndPoint( 'localhost', 8001, true, 'test', 3, 'test', 'test' );
		muSyncMock3.start( );
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://test:test@localhost:8001/v3',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode = statusCode;
					      responseValue.contentType = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://bla:bla@localhost:8001/v3',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode = statusCode;
					      responseValue.contentType = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muSyncTestMix',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode = statusCode;
					      responseValue.contentType = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muSyncTestMix.json',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode = statusCode;
					      responseValue.contentType = contentType;
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muSyncTestMix/83d946e6-288a-2444-9187-23c8387ae597',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode = statusCode;
					      responseValue.contentType = contentType;
		...
		runs( function()
		      {
			      expect( responseValue.statusCode ).toEqual( 200 );
			      expect( responseValue.contentType ).toEqual( 'text/html' );
			      expect( responseValue.grabbedDatas ).toEqual( '<!DOCTYPE html><html><head><title>muSyncTestMix muUID=83d946e6-288a-2444-9187-23c8387ae597 properties</title></head><body><h1>83d946e6-288a-2444-9187-23c8387ae597</h1><details><dl><dt><dfn>muSyncStamp</dfn></dt><dd>' + mockTestMix1.muSyncStamp + '</dd><dt><dfn>muORMTestMixString</dfn></dt><dd>name value is a string with this as default</dd><dt><dfn>muORMTestMixDate</dfn></dt><dd>Mon Mar 12 2012 00:00:00 GMT-0400 (EDT)</dd><dt><dfn>muORMTestMixNumeric</dfn></dt><dd>15</dd><dt><dfn>muUID</dfn></dt><dd>83d946e6-288a-2444-9187-23c8387ae597</dd></dl></details></body></html>' );
		      } );
	});
		...
		runs( function()
		      {
			      muBrowser.get
			      (
				      'http://localhost:8000/v1/muSyncTestMix/83d946e6-288a-2444-9187-23c8387ae597.json',
				      function( statusCode, contentType, grabbedDatas )
				      {
					      responseValue.statusCode = statusCode;
					      responseValue.contentType = contentType;
		...
		runs( function()
		      {
			      expect( responseValue.statusCode ).toEqual( 200 );
			      expect( responseValue.contentType ).toEqual( 'application/json' );
			      expect( responseValue.grabbedDatas ).toEqual( '{"muUID":"83d946e6-288a-2444-9187-23c8387ae597","muORMTestMixString":"name value is a string with this as default","muORMTestMixDate":"2012-03-12T04:00:00.000Z","muORMTestMixNumeric":15}' );
		      } );
	});
