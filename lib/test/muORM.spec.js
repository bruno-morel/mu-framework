...
*/
    ...
    it( "increment muUID correctly and put them in the Schema objectInstances hash table", function()
    {
        ...
        expect( muORMMock.objectInstances[ 'muORMTestNumeric' ] ).toEqual( { 2 : muORMTestNumericMock1, 3 : muORMTestNumericMock2 } );
	    ...
	    expect( muORMMock.objectInstances[ 'muORMTestNumeric' ][ '3' ] ).toBeUndefined( );
    });
