...
describe( "muORM", function()
{
	...
	it( "load muORMTestStoragePersistentMySQL schema, defines object and init the storage type on the object", function()
	{
		...
		expect( muORMTestStoragePersistentMySQLMockPrototype.Storage.storagePathOrURI ).toEqual( "mysql://muTest:mUt3ST@localhost/test" );
		expect( muORMTestStoragePersistentMySQLMockPrototype.Storage.userLogin ).toEqual( "muTest" );
    ...
    it( "load muORMTestStoragePersistentWithPath schema, defines object and init the storage type on the object", function()
    {
	    ...
	    expect( muORMTestStoragePersistentWithPathMockPrototype.Storage.driver.enginePath ).toEqual( "file" );
