...
describe( "muORM", function()
{
    ...
    it( "is loading all DB schema from directory", function()
    {
        ...
        expect( muORMTestStorageType ).toBeDefined( );
    ...
    {
        mu.fs.mkdir( '/tmp/testStoragePersistentORM/' );
        ...
        expect( muORMTestStorageTypeMockPrototype.Storage.storageType ).toEqual( "volatile" );
    });
