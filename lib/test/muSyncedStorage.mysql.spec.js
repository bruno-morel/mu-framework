			...
			runs( function()
			      {
				      expect( responseValue.statusCode ).toEqual( 200 );
				      expect( responseValue.contentType ).toEqual( 'text/html' );
				      expect( responseValue.grabbedDatas ).toEqual( '<!DOCTYPE html><html><head><title>mockSyncedMySQLAnonymous muUID=1 properties</title></head><body><h1>muUID<li>1</li></h1><div><ul>mockProperty<li>mockPropertyAnonymousValue1</li></ul></div></body></html>' );
			      } );
		} );
			...
			runs( function()
			      {
				      ...
				      expect( responseValue.grabbedDatas ).toEqual( '{"muUID":1,"mockProperty":"mockPropertyAnonymousValue1"}' );
			      } );
		} );
