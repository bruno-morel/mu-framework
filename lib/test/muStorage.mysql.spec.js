...
describe( "muStorageMySQL", function()
{
	...
	setTimeout( function( )
	            {
		            muMySQLDrvStorageMock.driver.Storages[ muMySQLDrvStorageMock.storagePathOrURI ].freeToDie();
		            muMySQLDrvStorageMock.driver.Storages[ muMySQLDrvStorageMock.storagePathOrURI ].relConnection();
	            }, 500 );
});