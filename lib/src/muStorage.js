...
( function ( exports )
{
    ...
    exports.Driver          = function( storageType, driverName, storagePathOrURI, userLogin, userPassword, params )
    {
        ...
        if( newStorage.driver == null )
        {
            ...
            newStorage.driver.relConnection = null; //release all object instance and the connexion from the engine
    ...
    exports.Driver.prototype.ownInstance     = function( objectToOwn, objectPrototypeName )
    {
        var storageEngine = this;
	    ...
	    if( storageEngine.driver.relInstance != null )
		    objectToOwn.relInstance = function( ){ storageEngine.driver.relInstance( storageEngine, prototypeName, objectToOwn ); };
