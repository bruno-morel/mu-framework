...
( function ( exports )
{
    ...
    exports.Driver.prototype.ownInstance     = function( objectToOwn, objectPrototypeName, optionalObjectInstanceList )
    {
        ...
        if( storageEngine.driver.ownInstance != null )
            storageEngine.driver.ownInstance( storageEngine, prototypeName, objectToOwn, optionalObjectInstanceList );

	    if( storageEngine.driver.relInstance != null )
		    objectToOwn.relInstance = function( ){ storageEngine.driver.relInstance( storageEngine,
		                                                                             prototypeName,
		                                                                             objectToOwn,
