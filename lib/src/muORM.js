 ...
 * 12-02-24 4:42 PM
 *
 * muORM is the abstraction layer that allows muStore driver to exchange data with mu as standard Javascript objects
 */
...
( function ( exports )
{
    ...
    var loadDbSchemaFromCode            = function( muORMSchema, jsonSnippet, jsObjectname )
    {
        ...
        with( scope )
        {
            this[ jsObjectname ] = function( optionalObject )
                {   //this is the auto-generated dynamic constructor for the new prototype (javascript 'class')
                    ...
                    objectPrototype[ "Storage" ].ownInstance( this, jsObjectname );
        ...
        if( parsedObject[ 'muStorageType' ] )
            ...
            objectGlobal.prototype[ "Storage" ] = this.defaultStorage;
