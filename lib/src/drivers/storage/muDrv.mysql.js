...
( function ( exports )
{
    ...
    exports.prepare         = function( storagePathOrURI, userLogin, userPassword, params )
    {
	    ...
	    mySQLDrv.enginePath = __filename;
    ...
    function mysqlDrvAddTransaction( storageContent, objectOrPropertyURN )
    {
        if( !storageContent.objectOrPropertyTransactionsCursor[ objectOrPropertyURN ] )
        {
            ...
            my.error( 'mysql driver : we have a transaction cursor withtout a last transactionID' );
	...
	function mysqlDrvInstanceRelease( objectStorageObject, prototypeURN, objectToOwn )
	{
		mysqlDrvGetPoolConnectionAndCall( objectStorageObject, prototypeURN + ':' + objectToOwn.muUID, mysqlDrvInstanceDel );
	}
    ...
    function mysqlDrvInstanceAdd( objectStorageObject, objectURN, connectionFromPool, transactionID )
    {
        ...
        var insertString = 'INSERT INTO ' + mu.mysql.escapeId( prototypeName ) +
                           ' SET muUID=' + storageContent.lastState[ objectURN ].muUID + ',?';
