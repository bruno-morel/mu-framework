...
( function ( exports )
{
	...
	exports.waitForTransactionOnObjectToFinish = function( objectStorageObject, prototypeURN, callbackToCallWhenFinished, callBackParams )
	{
		...
		if( storageContent.objectOrPropertyTransactionsCursor[ prototypeURN ] &&
    ...
    function mysqlDrvInstanceInit( objectStorageObject, prototypeURN, objectToOwn )
    {
		...
		*/
        ...
        objectToOwn.muUID = objectStorageObject.generateMuUID( );//driverLastMuIDTable[ prototypeURN ];
	...
	function mysqlDrvInstanceRelease( objectStorageObject, prototypeURN, objectToDelete, optionalObjectInstanceList )
	{
