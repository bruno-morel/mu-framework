...
( function ( exports )
{
    exports.EndPoint                = function( url, port, browsable, muORMSchema, version, defaultUserLogin, defaultUserPass, keyPath, certPath )
    {
	...
	{
		this.objectList     = typeof muORMSchema === 'object' ?
								//TODO : create a new muORM Schema object if the parameter given is a path
				                  ( muORMSchema.objectList ? muORMSchema.objectList : { } ) :
				                  { };
		this.objectInstances= typeof muORMSchema === 'object' ?
			                      ( muORMSchema.objectInstances ? muORMSchema.objectInstances : { } ) :
			                      { };
		this.APIName        = typeof muORMSchema === 'object' ? muORMSchema.SchemaName : null;

		if( typeof muORMSchema === 'object' &&
		    muORMSchema.muSync != this )
			muORMSchema.linkSync( this );
	};
