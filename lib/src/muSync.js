			...
			that.endpoint[ objectToGet ].syncInProgress[ idToGet ].onreadystatechange = function( )
			{
				if( that.endpoint[ objectToGet ].syncInProgress[ idToGet ].readyState == 4 )
				{
					...
					else
					{
						...
						if( !that.objectInstances[ objectToGet ][ idToGet ] )
							that.objectInstances[ objectToGet ][ idToGet ] = new that.objectList[ objectToGet ]( );

						that.objectInstances[ objectToGet ][ idToGet ].muUID = idToGet;
